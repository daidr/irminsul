          ...
          <div class="mt-4">
            ...
            <div v-else class="flex flex-col gap-2 max-h-[40dvh] overflow-auto">
              <div
                ...
                class="border p-3"
                :class="
                  banStatus(ban) === 'active' ? 'border-error/50 bg-error/5' : 'border-base-300'
                "
              >
                <!-- Display mode -->
                  ...
                  <div class="flex items-start justify-between gap-2">
                    <div class="min-w-0">
                      ...
                      <div class="mt-1.5 text-xs text-base-content/50">
                        ...
                        <div v-else>{{ formatTime(ban.start) }} 起，永久</div>
                      </div>
                      ...
                      <!-- Operator -->
                      <div
                        class="mt-1 text-[11px] text-base-content/30 flex items-center gap-1 flex-wrap"
                      >
                        <span>操作者：</span>
