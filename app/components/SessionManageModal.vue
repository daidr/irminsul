      ...
      <div class="modal-box sm:max-w-[560px]">
        ...
        <div class="join w-full mt-5">
          <button
            ...
            :class="activeTab === 'game' ? 'btn-active' : ''"
          ...
          <button
            class="btn btn-sm join-item flex-1"
            :class="activeTab === 'web' ? 'btn-active' : ''"
            @click="switchTab('web')"
          >
            网页会话
          </button>
        ...
        <template v-else>
          ...
          <div v-else class="mt-5 flex flex-col gap-3 max-h-[40dvh] overflow-auto">
            <div
              ...
              :class="
                s.isCurrent ? 'border-success/50 bg-base-200/50' : 'border-base-300 bg-base-200/50'
              "
            >
              <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col gap-1">
                  <div class="flex items-center gap-2">
                    ...
                    <span
                      v-if="s.isCurrent"
                      class="bg-success/15 px-2 py-0.5 text-[10px] text-success"
                    >
                      当前
                    </span>
                  </div>
              ...
              >
                <span
                  v-if="actionLoading === s.sessionId"
                  class="loading loading-spinner loading-xs"
                />
